...
const SkeletonCard = () => (
    <div className="border border-neutral-200 bg-white p-4 animate-pulse">
            ...
            <div className="space-y-6 relative min-h-screen">
                ...
                <div className="flex justify-between items-center pb-5 border-b border-gray-200">
                    ...
                    <Link href="/dashboard/general-ledger" passHref>
                        <button className="bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                            Go Back
                        </button>
                    </Link>
                </div>
                                    ...
                                    : journalLines.length > 0
                                        ? journalLines.map((line: JournalLine, index: number) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-3 text-gray-700">{line.accountName || "-"}</td>
