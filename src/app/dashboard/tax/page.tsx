...
export default function TaxPage() {
    ...
    const renderTaxAgencies = (items: any[]) => (
        <div className="bg-white border border-blue-200/50 rounded-[16px] p-4 shadow-sm w-full mx-auto transition-all duration-300 hover:shadow-md mb-5">
            <h3 className="text-xl leading-normal text-black capitalize font-medium">Tax Agencies</h3>
            <ul className="list-disc ml-5 space-y-2">
                {items.map((agency) => (
                    <li key={agency.Id} className="rounded bg-gray-50">
    ...
    const renderTaxRates = (items: any[]) => (
        <div className="bg-white shadow p-5 rounded mb-5">
            <h3 className="text-xl leading-normal text-black capitalize font-medium">Tax Rates</h3>
    ...
    return (
        <section className="mx-auto max-w-[1400px] w-full pt-5">
            <div className="bg-white border border-blue-200/50 rounded-[16px] p-4 shadow-sm w-full mx-auto transition-all duration-300 hover:shadow-md">
                <h1 className="text-xl leading-normal text-black capitalize font-medium">Tax</h1>

                <div className="bg-white border border-blue-200/50 rounded-[16px] p-4 shadow-sm w-full mx-auto mt-2 transition-all duration-300 hover:shadow-md mb-3">
                    <div className="flex gap-4 items-center">
                        <div className="image">
                            <Image src="/tax.svg" alt="Recurring Expenses" width={120} height={120} />
                        </div>
                        <div className="content">
                            <h2 className="text-xl leading-normal text-sky-800 capitalize font-semibold mb-2">Let's keep working on your taxes</h2>
                ...
                <div className="flex lg:flex-row flex-col gap-5">
                    {/* Tax Profile */}
                    <div className="flex-4/5 bg-white border border-blue-200/50 rounded-[16px] p-4 shadow-sm w-full mx-auto mt-2 transition-all duration-300 hover:shadow-md mb-5 h-max">
                        <div className="flex gap-4 justify-between items-center">
                            <div>
                                <h2 className="text-xl leading-normal text-black capitalize font-medium">Tax Related Data</h2>
                ...
                Continue Working
                        ...
                        <div className="mt-5">
                            {loadingTax ? (
                                <p className="text-gray-500 text-sm">Loading tax data...</p>
                            ) : taxData ? (
                                <>
                                ...
                                // Changed text-red-500 to text-gray-500 for "No tax data found."
                                <p className="text-gray-500 text-sm">No tax data found.</p>
                            )}
                        </div>
                    </div>

                    {/* Contact Info */}
                    <div className="flex-1/5 bg-white border border-blue-200/50 rounded-[16px] p-4 shadow-sm w-full mx-auto mt-2 transition-all duration-300 hover:shadow-md mb-5 h-max">
                        <div className="flex justify-between items-center">
                            <h2 className="text-xl leading-normal text-black capitalize font-medium">Contact Info</h2>
                        ...
                        {loadingCompany ? (
                            ...
                            <div className="flex flex-col gap-2 leading-4">
                                <p className="text-gray-700 mb-0">Company Name</p>
                                <p className="font-bold mb-2">{company.simplifiedProfile?.companyName || '—'}</p>

                                <p className="text-gray-700 mb-0">Legal Name</p>
                                ...
                                <p className="text-gray-700 mb-0">Address</p>
                                <p className="font-bold mb-2">{company.simplifiedProfile?.address || '—'}</p>

                                <p className="text-gray-700 mb-0">Start Date</p>
                                <p className="font-bold">{company.simplifiedProfile?.startDate || '—'}</p>
                            </div>
                        ) : (
                            // Changed text-red-500 to text-gray-500 for "No company data found."
