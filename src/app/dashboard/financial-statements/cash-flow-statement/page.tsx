      ...
      <div className="bg-card border border-border rounded-[10px] px-5 py-6 overflow-hidden">
        ...
        <div className="bg-card border border-border rounded-[16px] p-4 shadow-md w-full mx-auto transition-all duration-300 hover:shadow-md">
          <div className="flex justify-between items-center">
            <h2 className="text-xl leading-normal text-brand-body capitalize font-medium">Cash Flow</h2>
            {/* <button className="bg-primary text-card-foreground px-3 py-1.5 hover:bg-dark-primary">Apply Now</button> */}
          </div>
          <hr className="my-3 border-t border-gray-100" />

          <Suspense fallback={<div>Loading Cash Flow report...</div>}>
            <ReportTable reportType="CashFlow" />
          </Suspense>
        </div>
      </div>
    </section>
