   ...
   const [startDate, setStartDate] = useState<Date | null>(subDays(new Date(), 1)); // Default to one day before today
    ...
    return (
        <section className="mx-auto max-w-[1400px] w-full pt-5">
            {/* AR Aging Section */}
            <div className="bg-card border border-border rounded-[16px] p-4 shadow-md w-full mx-auto transition-all duration-300 hover:shadow-md mb-8">
                <h1 className="text-xl leading-normal text-brand-body capitalize font-medium">Accounts Receivable Aging</h1>
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:items-center pt-4 pb-4 gap-4">
                    ...
                    <Link href="/dashboard/ap-ar-aging/account-payble-aging" passHref>
                        <button className="px-4 py-2 bg-sidebar-background text-sidebar-foreground rounded-md hover:bg-sidebar-hover transition-colors mr-2 w-full md:w-auto shadow-md">
