    ...
    return (
        <section className="mx-auto max-w-[1400px] w-full pt-5">
            <div className="bg-card border border-border rounded-[16px] p-4 shadow-md w-full mx-auto transition-all duration-300 hover:shadow-md">
                <h1 className="text-xl leading-normal text-brand-body capitalize font-medium">Accounts</h1>

                <div className="flex lg:flex-row flex-col gap-5 mt-3">
                    <div className="flex-2/5 bg-card border border-border rounded-[16px] p-4 shadow-md w-full mx-auto transition-all duration-300 hover:shadow-md h-max">
                        <div className="flex flex-col space-y-1 mb-2">
                            <h2 className="text-xl leading-normal text-brand-body capitalize font-medium">My Accounts</h2>
                        </div>
                        <hr className="border-t border-border mb-3" />

                        <div className="flex justify-between items-center">
                            <h3 className="text-base font-semibold text-brand-body">Total Balance</h3>
                            {loading ? (
                                <SkeletonBalance />
                            ) : (
                        ...
                        {/* Bank Accounts */}
                        <div>
                            <h3 className="text-sm font-medium text-brand-body mb-3">Bank Accounts</h3>
                                        ...
                                        <li key={bank.id} className="flex items-center justify-between py-3">
                                            <div className="flex items-center gap-2">
                                                <div className="icon flex align-middle border px-3 border-border py-2 rounded leading-0">
                                                    <i className="fi fi-rr-bank text-muted-foreground text-xl"></i>
                                                </div>
                                                <div>
                        ...
                        {/* Credit Cards */}
                        <div>
                            <h3 className="text-sm font-medium text-brand-body">Credit Cards</h3>
                            <ul className="space-y-2">
                                {loading
                                    ...
                                    : creditCards.map((card: any) => (
                                        <li key={card.id} className="flex items-center justify-between py-3">
                                            <div className="flex items-center gap-2">
                                                <div className="icon flex align-middle border px-3 border-border py-2 rounded leading-0">
                                                    <i className="fi fi-rr-credit-card text-muted-foreground text-xl"></i>
                                                </div>
                                                <div>
                    ...
                    <div className="flex-3/5">
                        ...
                        <div className="bg-card border border-border rounded-[16px] p-4 shadow-md w-full mx-auto transition-all duration-300 hover:shadow-md">
                            <div className="flex justify-between mb-3">
                                <h3 className="text-xl leading-normal text-brand-body capitalize font-medium">Total Balance</h3>
                                <div className="text-end flex items-center gap-3">
                                    {loading ? (
                                        ...
                                        <>
                                            ...
                                            <span className="h-fit items-end px-2.5 py-0.5 rounded-full text-xs font-medium bg-sidebar-background text-sidebar-foreground shadow-sm">
                                                Estimated
                                            </span>
                                        </>
                                    )}
