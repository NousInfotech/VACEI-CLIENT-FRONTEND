                ...
                <div className="relative w-full max-w-md space-y-8">
                    ...
                    >
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            <Button
                                type="submit"
                                className="w-full h-12 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg"
                                style={{ 
                            ...
                            >
                                {loading ? (
                                    <span className="flex items-center justify-center">
                                        <svg className="animate-spin -ml-1 mr-3 h-5 w-5" style={{ color: `hsl(var(--primary-foreground))` }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
