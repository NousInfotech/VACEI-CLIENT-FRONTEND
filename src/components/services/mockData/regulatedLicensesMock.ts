...
export const regulatedLicensesMock: ServiceMockData = {
  ...
  {
    id: "rl-lib-root",
    folder_name: "Regulatory Filings",
    type: "folder",
    parentId: null,
  ...
  {
    id: "rl-lib-f1",
    file_name: "MFSA_Application_Form.pdf",
    type: "file",
    file_type: "PDF",
    file_size: 2450000,
    url: "#",
    folderId: "rl-lib-root",
    version: 1,
    tags: ["application", "mfsa"],
    uploaderId: "user-1",
    isDeleted: false,
  ...
  {
    id: "rl-lib-f2",
    file_name: "AML_Policy_Draft.docx",
    type: "file",
    file_type: "DOCX",
    file_size: 1850000,
    url: "#",
  ...
  {
    id: "rl-lib-f3",
    file_name: "Fit_Proper_Declaration.pdf",
    type: "file",
    file_type: "PDF",
    file_size: 920000,
    url: "#",
