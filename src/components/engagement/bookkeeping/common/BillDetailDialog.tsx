    ...
    >
      <div className="space-y-6 text-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="text-right">
            ...
            <p>
              ...
              {b.TxnDate ? new Date(b.TxnDate).toLocaleDateString() : "—"}
            </p>
            <p>
            ...
            <p>
              <span className="text-muted-foreground">A/P Account:</span>{" "}
              {b.APAccountRef?.name ?? "—"}
            </p>
            <p>
        ...
        <div className="flex justify-end">
          <div className="min-w-[220px] space-y-1 border-t border-border pt-3">
            <div className="flex justify-between font-semibold text-foreground pt-1">
              <span>Total</span>
              <span className="tabular-nums">
                {(b.TotalAmt ?? 0).toFixed(2)} {currency}
              </span>
            </div>
            {b.Balance != null && (
