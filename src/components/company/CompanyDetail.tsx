    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
          ...
          <p className="text-2xl font-medium">{data.authorizedShares.toLocaleString()}</p>
        ...
        <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
          ...
          <p className="text-2xl font-medium">{data.perShareValue.value} {data.perShareValue.currency}</p>
        ...
        <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
          ...
          <p className="text-2xl font-medium">{data.issuedShares.toLocaleString()}</p>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {data.totalShares.map((share, index) => (
